...
class BasePlateConnection(MomentConnection, IS800_2007, IS_5624_1993, IS1367_Part3_2002, Column):
    ...
    def base_plate_sketch(self, status):
        ...
        if self.connectivity == 'Moment Base Plate':
            if self.moment_bp_case == 'Case1':
                sketch_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Moment_BP.png"))
                width = 870
                height = 525
            elif self.moment_bp_case == 'Case2':
                sketch_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Moment_BP_C2.png"))
                width = 852
                height = 541
            elif self.moment_bp_case == 'Case3':
                sketch_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Moment_BP_C3.png"))
                width = 852
                height = 541
            else:
                sketch_path = ''
            ...
            sketch_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Welded_BP.png"))
            width = 852
            height = 541

        elif self.connectivity == 'Hollow/Tubular Column Base':
            if self.dp_column_designation[1:4] == 'SHS':
                sketch_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("SHS_BP.png"))
            elif self.dp_column_designation[1:4] == 'RHS':
                sketch_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("RHS_BP.png"))
            elif self.dp_column_designation[1:4] == 'CHS':
                sketch_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("CHS_BP.png"))
            else:
                sketch_path = ''
            width = 854
            height = 545
    ...
    def base_plate_detailing(self, status):
        ...
        if self.connectivity == 'Moment Base Plate':
            detailing_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Moment_BP_Detailing.png"))
            width = 702
            height = 518

        elif self.connectivity == 'Welded Column Base':
            detailing_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Welded_BP_Detailing.png"))
            width = 747
            height = 552

        elif self.connectivity == 'Hollow/Tubular Column Base':
            if self.dp_column_designation[1:4] == 'SHS':
                detailing_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("SHS_BP_Detailing.png"))
                width = 670
                height = 600
            elif self.dp_column_designation[1:4] == 'RHS':
                detailing_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("RHS_BP_Detailing.png"))
                width = 771
                height = 570
            elif self.dp_column_designation[1:4] == 'CHS':
                detailing_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("CHS_BP_Detailing.png"))
                width = 644
                height = 577
            else:
                detailing_path = ''
        ...
        if self.connectivity == 'Hollow/Tubular Column Base':
            ...
            if self.dp_column_designation[1:4] == 'SHS':
                if (self.shear_key_along_ColDepth == 'Yes') and (self.shear_key_along_ColWidth == 'Yes'):
                    key_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Key_SHS.png"))
                elif self.shear_key_along_ColDepth == 'Yes':
                    key_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Key_SHS_D.png"))
                elif self.shear_key_along_ColWidth == 'Yes':
                    key_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Key_SHS_B.png"))
                else:
                    key_path = ''
                ...
                if (self.shear_key_along_ColDepth == 'Yes') and (self.shear_key_along_ColWidth == 'Yes'):
                    key_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Key_RHS.png"))
                elif self.shear_key_along_ColDepth == 'Yes':
                    key_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Key_RHS_D.png"))
                elif self.shear_key_along_ColWidth == 'Yes':
                    key_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Key_RHS_B.png"))
                else:
                    key_path = ''
                ...
                if (self.shear_key_along_ColDepth == 'Yes') and (self.shear_key_along_ColWidth == 'Yes'):
                    key_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Key_CHS.png"))
                elif self.shear_key_along_ColDepth == 'Yes':
                    key_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Key_CHS_key1.png"))
                elif self.shear_key_along_ColWidth == 'Yes':
                    key_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Key_CHS_key2.png"))
                else:
                    key_path = ''
            ...
            if (self.shear_key_along_ColDepth == 'Yes') and (self.shear_key_along_ColWidth == 'Yes'):
                key_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("shear_key.png"))
            elif self.shear_key_along_ColDepth == 'Yes':
                key_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("shear_key_colD.png"))
            elif self.shear_key_along_ColWidth == 'Yes':
                key_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("shear_key_colB.png"))
            else:
                key_path = ''
    ...
    def weld_details(self, flag):
        ...
        if self.connectivity == 'Moment Base Plate':
            ...
            if (self.column_tf < 40.0) and (web_groove_weld == 'No'):
                weld_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Moment_BP_weld_details_1-1.png"))
            elif (self.column_tf < 40.0) and (web_groove_weld == 'Yes'):
                weld_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Moment_BP_weld_details_1-2.png"))
            elif self.column_tf > 40.0:
                weld_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Moment_BP_weld_details_2.png"))
            ...
            if self.weld_bp_groove == 'No':
                weld_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("BP_welded_weld_details.png"))
            else:
                if self.column_tf < 40.0:
                    weld_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Welded_BP_single_bevel.png"))
                if self.column_tf >= 40.0:
                    weld_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("Welded_BP_double_J.png"))
                else:
                    weld_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("BP_welded_weld_details.png"))
            ...
            if self.dp_column_designation[1:4] == 'SHS':
                if self.weld_bp_groove == 'Yes':
                    weld_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("SHS_BP_groove_weld_details.png"))
                else:
                    weld_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("SHS_BP_weld_details.png"))
                width = 890
                height = 590
            elif self.dp_column_designation[1:4] == 'RHS':
                if self.weld_bp_groove == 'Yes':
                    weld_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("RHS_BP_groove_weld_details.png"))
                else:
                    weld_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("RHS_BP_weld_details.png"))
                width = 880
                height = 470
            elif self.dp_column_designation[1:4] == 'CHS':
                if self.weld_bp_groove == 'Yes':
                    weld_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("CHS_BP_groove_weld_details.png"))
                else:
                    weld_path = str(files("osdag_core.data.ResourceFiles.images").joinpath("CHS_BP_weld_details.png"))
                width = 785
                height = 602
            else:
                weld_path = ''
