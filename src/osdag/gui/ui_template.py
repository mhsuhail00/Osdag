...
class Window(QMainWindow):
    ...
    def setupUi(self, MainWindow, main,folder):
        ...
        self.menuGraphics.addSeparator()
        self.menuGraphics.addAction(self.actionSave_Front_View)
        self.menuGraphics.addAction(self.actionSave_Top_View)
        self.menuGraphics.addAction(self.actionSave_Side_View)
        self.menuGraphics.addSeparator()
...
# Function for getting inputs from a file
    ...
    def retranslateUi(self):
        ...
        self.actionSave_Front_View.setText(_translate("MainWindow", "Show front view"))
        self.actionSave_Front_View.setShortcut(_translate("MainWindow", "Alt+Shift+F"))
        self.actionSave_Top_View.setText(_translate("MainWindow", "Show top view"))
        self.actionSave_Top_View.setShortcut(_translate("MainWindow", "Alt+Shift+T"))
        self.actionSave_Side_View.setText(_translate("MainWindow", "Show side view"))
